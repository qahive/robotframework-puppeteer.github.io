...
var nav_sections=$('section');var main_nav=$('.nav-menu, .mobile-nav');if(window.fixedScrollMenu!=undefined){main_nav.find('li').removeClass('active');main_nav.find('a[href*="#'+window.fixedScrollMenu+'"]').parent('li').addClass('active');}
else{$(window).on('scroll',function(){var cur_pos=$(this).scrollTop()+200;nav_sections.each(function(){var top=$(this).offset().top,bottom=top+$(this).outerHeight();if(cur_pos>=top&&cur_pos<=bottom){if(cur_pos<=bottom){main_nav.find('li').removeClass('active');}
main_nav.find('a[href*="#'+$(this).attr('id')+'"]').parent('li').addClass('active');}
if(cur_pos<300){$(".nav-menu ul:first li:first, .mobile-menu ul:first li:first").addClass('active');}});});}
